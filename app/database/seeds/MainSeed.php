...
class MainSeed {
    ...
    function run()
    {
		...
		$dosenbela->foto = "belawatihwidjaja.jpg";
		$dosenbela->save();
        ...
        $dosenani->foto = "aniatimurniarymurthy.jpg";
		$dosenani->save();
        ...
        $dosenherus->foto = "herusuhartanto.jpg";
		$dosenherus->save();
		...
		$dosentoem->foto = "toeminamasoem.jpg";
        $dosentoem->save();
		...
		$dosenzain->foto = "zainalarifinhasibuan.jpg";
		$dosenzain->save();
        ...
        $dosennizar->foto = "achmadnizarhidayanto.jpg";
		$dosennizar->save();
        ...
        $dosenadhi->foto = "adhiyuniartoly.jpg";
		$dosenadhi->save();
		...
		$dosenalfan->foto = "alfanfarizkiwicaksono.jpg";
        $dosenalfan->save();
        ...
        $dosenamril->foto = "amrilsyalim.jpg";
		$dosenamril->save();
		
		$dosenbagyo = new Dosen;
		$dosenbagyo->nip = "130517315";
		$dosenbagyo->nama = "Bagyo Y. Moeliodihardjo, Ir, M.Sc.";
		$dosenbagyo->jeniskelamin = Dosen::LAKI_LAKI;
		$dosenbagyo->pendidikan = 'S2';
        $dosenbagyo->foto = "bagyoymoeliodihardjo.jpg";
		$dosenbagyo->save();
        ...
        $dosenbayu->foto = "bayudistiawantrisedya.jpg";
		$dosenbayu->save();
		...
		$dosenbetty->foto = "bettypurwandari.jpg";
        $dosenbetty->save();
		...
		$dosenbob->foto = "bobhardiansyahbuddin.jpg";
        $dosenbob->save();
		...
		$dosenbobby->foto = "bobbyanazief.jpg";
        $dosenbobby->save();
		...
		$dosendadan->foto = "dadanhardianto.jpg";
        $dosendadan->save();
		...
		$dosendana->foto = "danaindrasensuse.jpg";
        $dosendana->save();
		...
		$dosendina->foto = "dinachahyati.jpg";
        $dosendina->save();
		...
		$doseneko->foto = "ekokuswardonobudiardjo.jpg";
        $doseneko->save();
		...
		$dosengladhi->foto = "gladhiguarddin.jpg";
        $dosengladhi->save();
		...
		$dosenharry->foto = "harrybudisantoso.jpg";
        $dosenharry->save();
		...
		$dosenheri->foto = "herikurniawan.jpg";
        $dosenheri->save();
		...
		$dosenruli->foto = "hisarmarulimanurung.jpg";
        $dosenruli->save();
		...
		$dosenstef->foto = "limyohanesstefanus.jpg";
        $dosenstef->save();
		...
		$dosenivan->foto = "mivanfanany.jpg";
        $dosenivan->save();
		...
		$dosenmirna->foto = "mirnaadriani.jpg";
        $dosenmirna->save();
		...
		$dosenhilman->foto = "muhammadhafizhuddinhilman.jpg";
        $dosenhilman->save();
		...
		$dosenrah->foto = "muhammadrahmatwidyanto.jpg";
        $dosenrah->save();
		...
		$dosenrifki->foto = "muhammadrifkishihab.jpg";
        $dosenrifki->save();
		...
		$dosenpetrus->foto = "petrusmursanto.jpg";
        $dosenpetrus->save();
		...
		$dosenpuspa->foto = "puspaindahatisandhyaduhita.jpg";
        $dosenpuspa->save();
		...
		$dosenputu->foto = "putuwurihandayani.jpg";
        $dosenputu->save();
		...
		$dosenyugo->foto = "ryugokartonoisal.jpg";
        $dosenyugo->save();
        ...
        $dosenibam->foto = "rahmatmsamikibrahim.jpg";
		$dosenibam->save();
		...
		$dosenrizal->foto = "rizalfathoniaji.jpg";
        $dosenrizal->save();
		...
		$dosensby->foto = "satriobaskoroyudhoatmojo.jpg";
        $dosensby->save();
		...
		$dosenyazid->foto = "setiadiyazid.jpg";
        $dosenyazid->save();
		...
		$dosenaminah->foto = "sitiaminah.jpg";
        $dosenaminah->save();
		...
		$dosensuryana->foto = "suryanasetiawan.jpg";
        $dosensuryana->save();
		...
		$dosenwcw->foto = "wahyucaturwibowo.jpg";
        $dosenwcw->save();
		...
		$dosenwidi->foto = "widijantosatyonugroho.jpg";
        $dosenwidi->save();
		...
		$dosenwisnu->foto = "wisnujatmiko.jpg";
        $dosenwisnu->save();
		...
		$dosenyova->foto = "yovaruldeviyani.jpg";
        $dosenyova->save();
		...
		$dosenyudho->foto = "yudhogirisucahyo.jpg";
        $dosenyudho->save();
		...
		$dosenadila->foto = "adilaalfakrisnadhi.jpg";
        $dosenadila->save();
		...
		$dosenagus->foto = "aguskurniawan.jpg";
        $dosenagus->save();
		...
		$dosenaris->foto = "arisaptawijaya.jpg";
        $dosenaris->save();
		...
		$dosenclara->foto = "claravania.jpg";
        $dosenclara->save();
		...
		$dosendewi->foto = "dewimairiza.jpg";
        $dosendewi->save();
		...
		$dosenpertami->foto = "pertamijuniahayuningtyas.jpg";
        $dosenpertami->save();
		...
		$dosentisha->foto = "tishamelia.jpg";
        $dosentisha->save();
		...
		$dosensam->foto = "samuellouvan.jpg";
        $dosensam->save();
		...
		$dosenaritonang->foto = "manusungalasebulonaritonang.jpg";
        $dosenaritonang->save();
		...
		$dosenkasfu->foto = "muhammadkasfuhammi.jpg";
        $dosenkasfu->save();
		...
		$dosenimairi->foto = "imairieitiveni.png";
        $dosenimairi->save();
		...
		$dosenbilih->foto = "bilihpriyogi.jpg";
        $dosenbilih->save();
		...
		$dosenqorib->foto = "qoribmunajat.jpg";
        $dosenqorib->save();
		...
		$dosenherup->foto = "nursidikherupraptono.jpg";
        $dosenherup->save();
		...
		$dosenave->foto = "aveadrianapinem.jpg";
        $dosenave->save();
		
		$dosenhaya = new Dosen;
		$dosenhaya->nama = "Haya Rizqi Fajrina S.Kom.";
		$dosenhaya->jeniskelamin = Dosen::PEREMPUAN;
		$dosenhaya->pendidikan = 'S1';
		$dosenhaya->foto = "hayarizqifajrina.jpg";
        $dosenhaya->save();
		...
		$dosenarlisa->foto = "arlisayuliawati.jpg";
        $dosenarlisa->save();
		...
		$dosenikac->foto = "ikachandrahapsari.jpg";
        $dosenikac->save();
		
		$dosenariefr = new Dosen;
		$dosenariefr->nip = "121303006";
		$dosenariefr->nama = "Dr. Arief Ramadhan S.Kom.";
		$dosenariefr->jeniskelamin = Dosen::LAKI_LAKI;
		$dosenariefr->pendidikan = 'S3';
		$dosenariefr->foto = "arieframadhan.jpg";
        $dosenariefr->save();
		...
		$dosenherdi->foto = "herdiansyahrhamadan.jpg";
        $dosenherdi->save();
		...
		$dosenmega->foto = "meganingrumaristajiwanggi.jpg";
        $dosenmega->save();
		...
		$dosenhadaiq->foto = "hadaiqrolissanabila.jpg";
        $dosenhadaiq->save();
		...
		$dosennurul->foto = "nurulqomariyah.jpg";
        $dosennurul->save();
		...
		$dosenedy->foto = "iputuedysuardiyanaputra.jpg";
        $dosenedy->save();
		...
		$dosengilang->foto = "gilangkusumajati.jpg";
        $dosengilang->save();
		...
		$dosenhanif->foto = "hanifrasyidi.jpg";
        $dosenhanif->save();
		...
		$dosenmaya->foto = "mayaretnoayusetyautami.jpg";
        $dosenmaya->save();
		...
		$dosenrahmad->foto = "rahmadmahendra.jpg";
        $dosenrahmad->save();
		...
		$dosenary->foto = "arynoviyanto.jpg";
        $dosenary->save();
		...
		$dosenangga->foto = "angghasatyanugraha.jpg";
        $dosenangga->save();
		...
		$dosentieta->foto = "tietaantarestiriskaputri.jpg";
        $dosentieta->save();
		...
		$dosenyayan->foto = "yulistiyanwardhana.jpg";
        $dosenyayan->save();
		...
		$dosenhisyam->foto = "hisyamfahmi.jpg";
        $dosenhisyam->save();
		...
		$matkul_matdas1->save();
		$matkul_matdas1->dosen()->attach($dosenkas->id);
		$matkul_matdas1->dosen()->attach($dosenlia->id);
		$matkul_matdas1->dosen()->attach($dosenrah->id);
		...
		$matkul_ddp->save();
		$matkul_ddp->dosen()->attach($dosengilang->id);
		$matkul_ddp->dosen()->attach($dosenbayu->id);
		$matkul_ddp->dosen()->attach($dosendenny->id);
		$matkul_ddp->dosen()->attach($dosenalfan->id);
		$matkul_ddp->dosen()->attach($dosenclara->id);
		$matkul_ddp->dosen()->attach($dosenhanif->id);
		...
		$matkul_sda->save();
		$matkul_sda->dosen()->attach($dosengilang->id);
		$matkul_sda->dosen()->attach($dosenbayu->id);
		$matkul_sda->dosen()->attach($dosendenny->id);
		$matkul_sda->dosen()->attach($dosenhadaiq->id);
		...
		$matkul_alin->save();
		$matkul_alin->dosen()->attach($dosenlia->id);
		$matkul_alin->dosen()->attach($dosennizar->id);
		$matkul_alin->dosen()->attach($dosenhadaiq->id);
		$matkul_alin->dosen()->attach($dosenkas->id);
		...
		$matkul_matdis2->save();
		$matkul_matdis2->dosen()->attach($dosentieta->id);
		$matkul_matdis2->dosen()->attach($dosendina->id);
		$matkul_matdis2->dosen()->attach($dosenevi->id);
		...
		$matkul_statprob->dosen()->attach($dosenika->id);
		$matkul_statprob->dosen()->attach($dosenary->id);
		$matkul_statprob->dosen()->attach($dosenalfan->id);
		...
		$matkul_ppw->save();
		$matkul_ppw->dosen()->attach($dosenherup->id);
		$matkul_ppw->dosen()->attach($dosengilang->id);
		$matkul_ppw->dosen()->attach($dosenhisyam->id);
		$matkul_ppw->dosen()->attach($dosenrizal->id);
		...
		$matkul_os->save();
		$matkul_os->dosen()->attach($dosenibam->id);
		$matkul_os->dosen()->attach($dosenamril->id);
		$matkul_os->dosen()->attach($dosenhilman->id); 
		...
		$matkul_basdat->save();
		$matkul_basdat->dosen()->attach($dosenyova->id);
		$matkul_basdat->dosen()->attach($dosenmaya->id);
		$matkul_basdat->dosen()->attach($dosenika->id);
		$matkul_basdat->dosen()->attach($dosenevi->id);
		$matkul_basdat->dosen()->attach($dosenclara->id);
		$matkul_basdat->dosen()->attach($dosenyayan->id);
		...
		$matkul_rpl->save();
		$matkul_rpl->dosen()->attach($dosensby->id);
		$matkul_rpl->dosen()->attach($dosenherup->id);
		$matkul_rpl->dosen()->attach($doseniis->id);
		$matkul_rpl->dosen()->attach($dosenika->id);
		...
		$matkul_kp->save();
		$matkul_kp->dosen()->attach($dosenherup->id);
		$matkul_kp->dosen()->attach($dosenimairi->id);
		$matkul_kp->dosen()->attach($dosenave->id);
		$matkul_kp->dosen()->attach($dosensby->id);
		$matkul_kp->dosen()->attach($dosenbilih->id);
		...
		$matkul_komas->save();
		$matkul_komas->dosen()->attach($dosenwidi->id);
		$matkul_komas->dosen()->attach($dosenyugo->id);
		...
		$matkul_psd->save();
		$matkul_psd->dosen()->attach($dosenefi->id);
		$matkul_psd->dosen()->attach($dosenari->id);
		$matkul_psd->dosen()->attach($dosenwisnu->id);
		...
		$matkul_pok->save();
		$matkul_pok->dosen()->attach($dosenhanif->id);
		$matkul_pok->dosen()->attach($dosenari->id);
		$matkul_pok->dosen()->attach($dosenwisnu->id);
		...
		$matkul_matdas2->save();
		$matkul_matdas2->dosen()->attach($dosenangga->id);
		...
		$matkul_tba->save();
		$matkul_tba->dosen()->attach($dosendina->id);
		$matkul_tba->dosen()->attach($dosenstef->id);
		...
		$matkul_pemdek->save();
		$matkul_pemdek->dosen()->attach($dosenade->id);
		$matkul_pemdek->dosen()->attach($dosenalfan->id);
		$matkul_pemdek->dosen()->attach($dosenevi->id);
		...
		$matkul_sisprog->save();
		$matkul_sisprog->dosen()->attach($dosengladhi->id);
		$matkul_sisprog->dosen()->attach($dosenari->id);
		...
		$matkul_sc->save();
		$matkul_sc->dosen()->attach($dosenruli->id);
		$matkul_sc->dosen()->attach($dosenhanif->id);
		...
		$matkul_pi->save();
		$matkul_pi->dosen()->attach($dosenariefr->id);
		$matkul_pi->dosen()->attach($dosenzain->id);
		$matkul_pi->dosen()->attach($dosenyugo->id);
		...
		$matkul_jarkom->save();
		$matkul_jarkom->dosen()->attach($dosenheri->id);
		$matkul_jarkom->dosen()->attach($dosenari->id);
		...
		$matkul_anum->save();
		$matkul_anum->dosen()->attach($dosencan->id);
		$matkul_anum->dosen()->attach($dosenherus->id);
		$matkul_anum->dosen()->attach($dosenmega->id);
		...
		$matkul_daa->save();
		$matkul_daa->dosen()->attach($dosenyugo->id);
		$matkul_daa->dosen()->attach($dosenarlisa->id);
		$matkul_daa->dosen()->attach($dosenbilih->id);
		...
		$matkul_ppl->save();
		$matkul_ppl->dosen()->attach($dosenhadaiq->id);
		$matkul_ppl->dosen()->attach($dosensby->id);
		$matkul_ppl->dosen()->attach($dosenputu->id);
		$matkul_ppl->dosen()->attach($doseneko->id);
		...
		$matkul_pkp->save();
		$matkul_pkp->dosen()->attach($dosenherus->id);
		...
		$matkul_embed->save();
		$matkul_embed->dosen()->attach($dosenwisnu->id);
		$matkul_embed->dosen()->attach($dosenstef->id);
		...
		$matkul_ti->save();
		$matkul_ti->dosen()->attach($dosencan->id);
		...
		$matkul_tk->save();
		$matkul_tk->dosen()->attach($dosenherus->id);
		...
		$matkul_cis->save();
		$matkul_cis->dosen()->attach($dosenstef->id);
		...
		$matkul_law->save();
		$matkul_law->dosen()->attach($dosenbayu->id);
		...
		$matkul_psd2->save();
		$matkul_psd2->dosen()->attach($dosenwisnu->id);
		...
		$matkul_st->save();
		$matkul_st->dosen()->attach($dosengladhi->id);
		...
		$matkul_ubi->save();
		$matkul_ubi->dosen()->attach($dosenbob->id);
		...
		$matkul_robotik->save();
		$matkul_robotik->dosen()->attach($dosenwisnu->id);
		...
		$matkul_rsd->save();
		$matkul_rsd->dosen()->attach($dosenpetrus->id);
		$matkul_rsd->dosen()->attach($dosenwisnu->id);
		...
		$matkul_sister->save();
		$matkul_sister->dosen()->attach($dosenharry->id);
		$matkul_sister->dosen()->attach($dosenhadaiq->id);
		$matkul_sister->dosen()->attach($dosendadan->id);
		...
		$matkul_banjut->save();
		$matkul_banjut->dosen()->attach($dosennizar->id);
		$matkul_banjut->dosen()->attach($dosenyova->id);
		...
		$matkul_grafkom->save();
		$matkul_grafkom->dosen()->attach($dosendadan->id);
		...
		$matkul_gamedev->save();
		$matkul_gamedev->dosen()->attach($dosenruli->id);
		...
		$matkul_pemlog->save();
		$matkul_pemlog->dosen()->attach($dosenade->id);
		$matkul_pemlog->dosen()->attach($dosenruli->id);
		...
		$matkul_pmpl->save();
		$matkul_pmpl->dosen()->attach($dosenade->id);
		...
		$matkul_sw->save();
		$matkul_sw->dosen()->attach($dosenwcw->id);
		...
		$matkul_pbk->save();
		$matkul_pbk->dosen()->attach($dosenharry->id);
		...
		$matkul_metfor->save();
		$matkul_metfor->dosen()->attach($dosenbela->id);
		$matkul_metfor->dosen()->attach($dosenstef->id);
		...
		$matkul_tktpl->save();
		$matkul_tktpl->dosen()->attach($dosendenny->id);
		...
		$matkul_dm->save();
		$matkul_dm->dosen()->attach($dosenivan->id);
		...
		$matkul_pengcit->save();
		$matkul_pengcit->dosen()->attach($dosenani->id);
		...
		$matkul_pm->save();
		$matkul_pm->dosen()->attach($dosenito->id);
		...
		$matkul_pbm->save();
		$matkul_pbm->dosen()->attach($dosenruli->id);
		...
		$matkul_perin->save();
		$matkul_perin->dosen()->attach($dosenmirna->id);
		...
		$matkul_sig->save();
		$matkul_sig->dosen()->attach($dosendadan->id);
		...
		$matkul_bio->save();
		$matkul_bio->dosen()->attach($dosenito->id);
		...
		$matkul_alinn->nama = "Aljabar Linier Numerik";
		...
		$matkul_alinn->save();
		$matkul_alinn->dosen()->attach($dosendina->id);
		$matkul_alinn->dosen()->attach($dosenstef->id);
		...
		$matkul_komnak->save();
		$matkul_komnak->dosen()->attach($dosenrahmad->id);
		...
		$matkul_lk->save();
		$matkul_lk->dosen()->attach($dosenstef->id);
		...
		$matkul_tkl->save();
		$matkul_tkl->dosen()->attach($dosenstef->id);
		...
		$matkul_ppsi->save();
		$matkul_ppsi->dosen()->attach($doseniik->id);
		$matkul_ppsi->dosen()->attach($dosenpuspa->id);
		...
		$matkul_adbis->save();
		$matkul_adbis->dosen()->attach($dosenhaya->id);
		$matkul_adbis->dosen()->attach($dosenave->id);
		$matkul_adbis->dosen()->attach($dosenmega->id);
		...
		$matkul_ddak->save();
		$matkul_ddak->dosen()->attach($dosenadhi->id);
		$matkul_ddak->dosen()->attach($dosenhisyam->id);
		$matkul_ddak->dosen()->attach($dosenefi->id);
		...
		$matkul_erp->save();
		$matkul_erp->dosen()->attach($dosenyova->id);
		$matkul_erp->dosen()->attach($dosenindra->id);
		...
		$matkul_ro->save();
		$matkul_ro->dosen()->attach($dosenarlisa->id);
		$matkul_ro->dosen()->attach($dosenaminah->id);
		$matkul_ro->dosen()->attach($dosenika->id);
		...
		$matkul_crm->save();
		$matkul_crm->dosen()->attach($dosenikac->id);
		$matkul_crm->dosen()->attach($doseneko->id);
		$matkul_crm->dosen()->attach($dosenputu->id);
		...
		$matkul_scm->save();
		$matkul_scm->dosen()->attach($dosenikac->id);
		$matkul_scm->dosen()->attach($dosenpuspa->id);
		...
		$matkul_jarkomdat->dosen()->attach($dosenariefr->id);
		$matkul_jarkomdat->dosen()->attach($dosenbetty->id);
		$matkul_jarkomdat->dosen()->attach($dosenrizal->id);
		...
		$matkul_siak->save();
		$matkul_siak->dosen()->attach($dosenikac->id);
		...
		$matkul_mppi->save();
		$matkul_mppi->dosen()->attach($dosenzain->id);
		$matkul_mppi->dosen()->attach($dosenariefr->id);
		...
		$matkul_propensi->dosen()->attach($dosenherup->id);
		$matkul_propensi->dosen()->attach($doseniis->id);
		$matkul_propensi->dosen()->attach($dosenbetty->id);
		$matkul_propensi->dosen()->attach($dosenpuspa->id);
		$matkul_propensi->dosen()->attach($doseniik->id);
		...
		$matkul_mpti->save();
		$matkul_mpti->dosen()->attach($dosenave->id);
		$matkul_mpti->dosen()->attach($dosenindra->id);
		...
		$matkul_kombistek->dosen()->attach($dosenherdi->id);
		$matkul_kombistek->dosen()->attach($dosenrifki->id);
		//$matkul_kombistek->dosen()->attach($dosenlaras->id);
		...
		$matkul_adsis->save();
		$matkul_adsis->dosen()->attach($dosenheri->id);
		...
		$matkul_itim->save();
		$matkul_itim->dosen()->attach($dosenari->id);
		$matkul_itim->dosen()->attach($dosengladhi->id);
		...
		$matkul_mlti->save();
		$matkul_mlti->dosen()->attach($dosenkasfu->id);
		...
		$matkul_mki->save();
		$matkul_mki->dosen()->attach($dosenamril->id);
		...
		$matkul_tm->save();
		$matkul_tm->dosen()->attach($dosenbob->id);
		$matkul_tm->dosen()->attach($dosenhilman->id);
		...
		$matkul_ddasi->save();
		$matkul_ddasi->dosen()->attach($dosenkasfu->id);
		$matkul_ddasi->dosen()->attach($dosenheri->id);
		...
		$matkul_msi->save();
		$matkul_msi->dosen()->attach($dosenpuspa->id);
		$matkul_msi->dosen()->attach($doseniik->id);
		...
		$matkul_pplos->save();
		$matkul_pplos->dosen()->attach($dosenhilman->id);
		...
		$matkul_bi->save();
		$matkul_bi->dosen()->attach($dosenimairi->id);
		$matkul_bi->dosen()->attach($dosenivan->id);
		$matkul_bi->dosen()->attach($dosenindra->id);
		$matkul_bi->dosen()->attach($dosenaminah->id);
		...
		$matkul_techno->save();
		$matkul_techno->dosen()->attach($dosenbob->id);
		$matkul_techno->dosen()->attach($doseneko->id);
		...
		$matkul_ecom->save();
		$matkul_ecom->dosen()->attach($dosenimairi->id);
		$matkul_ecom->dosen()->attach($dosenbilih->id);
		...
		$matkul_konfig->save();
		$matkul_konfig->dosen()->attach($dosenindra->id);
		...
		$matkul_sik->save();
		$matkul_sik->dosen()->attach($dosenstef->id);
		...
		$matkul_mp->save();
		$matkul_mp->dosen()->attach($dosenputu->id);
		...
		$matkul_eai->save();
		$matkul_eai->dosen()->attach($dosenputu->id);
		$matkul_eai->dosen()->attach($dosenqorib->id);
		$matkul_eai->dosen()->attach($dosenrizal->id);
		
		$matkul_sda->prasyarat()->attach($matkul_ddp->id);
		$matkul_ppw->prasyarat()->attach($matkul_ddp->id);
		$matkul_os->prasyarat()->attach($matkul_ddak->id);
		$matkul_os->prasyarat()->attach($matkul_pok->id);
		$matkul_basdat->prasyarat()->attach($matkul_sda->id);
		$matkul_rpl->prasyarat()->attach($matkul_ddp->id);
		$matkul_pok->prasyarat()->attach($matkul_psd->id);
		$matkul_pok->prasyarat()->attach($matkul_ddp->id);
		$matkul_tba->prasyarat()->attach($matkul_matdis1->id);
		$matkul_tba->prasyarat()->attach($matkul_matdis2->id);
		$matkul_pemdek->prasyarat()->attach($matkul_sda->id);
		$matkul_sisprog->prasyarat()->attach($matkul_sda->id);
		$matkul_sisprog->prasyarat()->attach($matkul_os->id);
		$matkul_sc->prasyarat()->attach($matkul_statprob->id);
		$matkul_sc->prasyarat()->attach($matkul_sda->id);
		$matkul_sc->prasyarat()->attach($matkul_matdis1->id);
		$matkul_jarkom->prasyarat()->attach($matkul_os->id);
		$matkul_anum->prasyarat()->attach($matkul_matdis1->id);
		$matkul_anum->prasyarat()->attach($matkul_matdas1->id);
		$matkul_daa->prasyarat()->attach($matkul_sda->id);
		$matkul_ppl->prasyarat()->attach($matkul_rpl->id);
		$matkul_pkp->prasyarat()->attach($matkul_os->id);
		$matkul_pkp->prasyarat()->attach($matkul_alin->id);
		$matkul_pkp->prasyarat()->attach($matkul_matdas2->id);
		$matkul_osk->prasyarat()->attach($matkul_pok->id);
		$matkul_embed->prasyarat()->attach($matkul_pok->id);
		$matkul_ti->prasyarat()->attach($matkul_statprob->id);
		$matkul_ti->prasyarat()->attach($matkul_matdas2->id);
		$matkul_tk->prasyarat()->attach($matkul_sda->id);
		$matkul_tk->prasyarat()->attach($matkul_tba->id);
		$matkul_cis->prasyarat()->attach($matkul_matdis1->id);
		$matkul_cis->prasyarat()->attach($matkul_matdis2->id);
		$matkul_cis->prasyarat()->attach($matkul_jarkom->id);
		$matkul_cis->prasyarat()->attach($matkul_statprob->id);
		$matkul_law->prasyarat()->attach($matkul_jarkom->id);
		$matkul_law->prasyarat()->attach($matkul_ppw->id);
		$matkul_sp->prasyarat()->attach($matkul_statprob->id);
		$matkul_sp->prasyarat()->attach($matkul_jarkom->id);
		$matkul_psd2->prasyarat()->attach($matkul_statprob->id);
		$matkul_psd2->prasyarat()->attach($matkul_pok->id);
		$matkul_st->prasyarat()->attach($matkul_jarkom->id);
		$matkul_ubi->prasyarat()->attach($matkul_jarkom->id);
		$matkul_robotik->prasyarat()->attach($matkul_pok->id);
		$matkul_robotik->prasyarat()->attach($matkul_sc->id);
		$matkul_rsd->prasyarat()->attach($matkul_pok->id);
		$matkul_sister->prasyarat()->attach($matkul_ppw->id);
		$matkul_banjut->prasyarat()->attach($matkul_basdat->id);
		$matkul_grafkom->prasyarat()->attach($matkul_alin->id);
		$matkul_grafkom->prasyarat()->attach($matkul_sda->id);
		$matkul_grafkom->prasyarat()->attach($matkul_sda->id);
		$matkul_pemlog->prasyarat()->attach($matkul_matdis1->id);
		$matkul_pemlog->prasyarat()->attach($matkul_ddp->id);
		$matkul_pmpl->prasyarat()->attach($matkul_rpl->id);
		$matkul_sw->prasyarat()->attach($matkul_sc->id);
		$matkul_sw->prasyarat()->attach($matkul_ppw->id);
		$matkul_pbk->prasyarat()->attach($matkul_ppw->id);
		$matkul_metfor->prasyarat()->attach($matkul_matdis1->id);
		$matkul_metfor->prasyarat()->attach($matkul_matdis2->id);
		$matkul_metfor->prasyarat()->attach($matkul_sda->id);
		$matkul_dm->prasyarat()->attach($matkul_basdat->id);
		$matkul_dm->prasyarat()->attach($matkul_sc->id);
		$matkul_pengcit->prasyarat()->attach($matkul_alin->id);
		$matkul_pengcit->prasyarat()->attach($matkul_sda->id);
		$matkul_pengcit->prasyarat()->attach($matkul_matdas2->id);
		$matkul_pm->prasyarat()->attach($matkul_sc->id);
		$matkul_pbm->prasyarat()->attach($matkul_sc->id);
		$matkul_pbm->prasyarat()->attach($matkul_tba->id);
		$matkul_pengmul->prasyarat()->attach($matkul_sda->id);
		$matkul_perin->prasyarat()->attach($matkul_sda->id);
		$matkul_gm->prasyarat()->attach($matkul_grafkom->id);
		$matkul_sig->prasyarat()->attach($matkul_basdat->id);
		$matkul_sig->prasyarat()->attach($matkul_rpl->id);
		$matkul_cg->prasyarat()->attach($matkul_sda->id);
		$matkul_bio->prasyarat()->attach($matkul_sda->id);
		$matkul_bio->prasyarat()->attach($matkul_statprob->id);
		$matkul_pd->prasyarat()->attach($matkul_alin->id);
		$matkul_pd->prasyarat()->attach($matkul_matdas2->id);
		$matkul_asn->prasyarat()->attach($matkul_anum->id);
		$matkul_alinn->prasyarat()->attach($matkul_anum->id);
		$matkul_komnak->prasyarat()->attach($matkul_sc->id);
		$matkul_lk->prasyarat()->attach($matkul_sc->id);
		$matkul_tkl->prasyarat()->attach($matkul_anum->id);
		$matkul_ddak->prasyarat()->attach($matkul_ddp->id);
		$matkul_erp->prasyarat()->attach($matkul_adbis->id);
		$matkul_ro->prasyarat()->attach($matkul_anum->id);
		$matkul_crm->prasyarat()->attach($matkul_erp->id);
		$matkul_msdm->prasyarat()->attach($matkul_erp->id);
		$matkul_scm->prasyarat()->attach($matkul_erp->id);
		$matkul_jarkomdat->prasyarat()->attach($matkul_os->id);
		$matkul_siak->prasyarat()->attach($matkul_erp->id);
		$matkul_propensi->prasyarat()->attach($matkul_rpl->id);
		$matkul_propensi->prasyarat()->attach($matkul_basdat->id);
		$matkul_mpti->prasyarat()->attach($matkul_ppm->id);
		$matkul_kombistek->prasyarat()->attach($matkul_anum->id);
		$matkul_adsis->prasyarat()->attach($matkul_os->id);
		$matkul_itim->prasyarat()->attach($matkul_basdat->id);
		$matkul_itim->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_mlti->prasyarat()->attach($matkul_ppsi->id);
		$matkul_mlti->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_mki->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_tm->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_ddasi->prasyarat()->attach($matkul_ppsi->id);
		$matkul_ddasi->prasyarat()->attach($matkul_basdat->id);
		$matkul_ddasi->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_msi->prasyarat()->attach($matkul_ppsi->id);
		$matkul_msi->prasyarat()->attach($matkul_basdat->id);
		$matkul_msi->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_pplos->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_bi->prasyarat()->attach($matkul_basdat->id);
		$matkul_ppp->prasyarat()->attach($matkul_adbis->id);
		$matkul_ecom->prasyarat()->attach($matkul_ppsi->id);
		$matkul_konfig->prasyarat()->attach($matkul_erp->id);
		$matkul_konfig->prasyarat()->attach($matkul_ddp->id);
		$matkul_sik->prasyarat()->attach($matkul_ppsi->id);
		$matkul_sik->prasyarat()->attach($matkul_basdat->id);		
		$matkul_mp->prasyarat()->attach($matkul_anum->id);
		$matkul_eai->prasyarat()->attach($matkul_jarkomdat->id);
		$matkul_eai->prasyarat()->attach($matkul_basdat->id);
