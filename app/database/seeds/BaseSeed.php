...
class BaseSeed {
    ...
    function run()
    {
		...
		$dosenhil = new Dosen;
		$dosenhil ->nip = "121203003";
		$dosenhil ->nama = "Muhammad Hafizhuddin Hilman, S.Kom., M.Kom.";
		$dosenhil ->jeniskelamin = "Laki-Laki";
		$dosenhil ->ttl = date("1987-04-21"); 
		...
		$dosenruli = new Dosen;
		$dosenruli ->nip = "121303001";
		$dosenruli ->nama = "Tieta Antaresti Riska Putri S.Kom.";
		$dosenruli ->jeniskelamin = "Perempuan";
		$dosenruli ->ttl = date("1992-01-15");
