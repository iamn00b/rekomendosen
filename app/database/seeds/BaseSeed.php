...
class MainSeed {
    ...
    function run()
    {
        ...
        $dosenherus->foto = "heruauhartanto.jpg";
		$dosenherus->save();
		...
		$dosenzain->nama = "zainalarifinhasibuan.jpg";
		$dosenzain->save();
        ...
        $dosenibam->nama = "rahmatmsamikibrahim.jpg";
		$dosenibam->save();
		...
		$dosenwisnu->foto = "sisnujatmiko.jpg";
        $dosenwisnu->save();
		...
		$dosennhaya->foto = "hayarizqifajrina.jpg";
        $dosenhaya->save();
