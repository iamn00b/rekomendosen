...
$app->get('/matakuliah/', function () use ($app) 		{ (new Home())->tampilmatkul(); 		})->name('matkul');
$app->get('/logout/', function () use ($app) 	{ (new Home())->logout(); 		})->name('logout');
$app->get('/rincianmatkul/', function () use ($app) 		{ (new Home())->tampilrincianmatkul(); 		})->name('rincianmatkul');
